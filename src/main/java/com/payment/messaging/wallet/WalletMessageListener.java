package com.payment.messaging.wallet;
...
import com.payment.service.PaymentCoordinatorService;
...
public class WalletMessageListener {
    ...
    public WalletMessageListener(PaymentCoordinatorService paymentCoordinatorService) {
