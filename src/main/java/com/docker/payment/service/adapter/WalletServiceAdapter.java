package com.docker.payment.service.adapter;

import com.docker.payment.dto.payment.internal.request.ReservationRequest;
import com.docker.payment.dto.payment.internal.response.ReservationResponse;
import com.docker.payment.exception.InternalServiceCommunicationException;
import com.docker.payment.exception.ReservationException;
import com.docker.payment.model.payment.PaymentStatus;
import com.docker.payment.service.PaymentDataAccessService;
import com.docker.payment.service.external.WalletClient;
